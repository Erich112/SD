...
class MessageProcessorMicroservice {
    ...
    private fun receiveAndProcessMessages() {
        ...
        val receiveInQueueSubscription = receiveInQueueObservable.distinct()
            .subscribeBy(
                onNext = {
                ...
                onComplete = {
                    ...
                    var ListaSortataDupaTimestamp = messageQueue.sortedBy{
                        it.timestamp
                    }
                    messageQueue.clear()
                    for (msg in ListaSortataDupaTimestamp)
                    {
